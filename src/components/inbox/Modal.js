...
export default function Modal({ open, control }) {
    ...
    const [editConversation,{isSuccess:editConversationSuccess}] = useEditConversationMutation();
            ...
            <>
                ...
                <div className="rounded w-[400px] lg:w-[600px] space-y-8 bg-white p-10 absolute top-1/2 left-1/2 z-20 -translate-x-1/2 -translate-y-1/2">
                    ...
                    >
                        ...
                        {participant?.length===0 && <Error message="This user doesn't exits" /> }
                        {participant?.length>0 && participant[0].email === myEmail && <Error message="You can't send message to yourself" /> }
